...
A [team from Baidu][EGL paper] adapted this method for speech recognition, using it to choose from an unlabeled set of utterances and using a deep recurrent architecture as the architecture.
