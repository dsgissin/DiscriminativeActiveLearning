...
So now that we have a feel for the method's advantages and disadvantages, we can try and come up with ideas for tweaking our model a little.

### Handling Outliers
TODO: write about the ideas for handling the outliers...
